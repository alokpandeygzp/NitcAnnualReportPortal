            ...
            <div class="content_container">
                <div class="top_container">
                    <form action="" method="" enctype="multipart/form-data" class="form_field">
                        <input type="file" id="enrolment_file" name="enrolment_file" accept=".xlsx, .csv, .xls" class="input-fields">
                ...
                <div class="table_container table_height_2">
                    <table border="1">
                        <thead>
                            <tr>
                                <th class="wrap_text">Specialization</th>
                                <th class="wrap_text">OP</th>
                                <th class="wrap_text">OP(PH)</th>
                                <th class="wrap_text">OP(EWS)</th>
                                <th class="wrap_text">OP(EWS)PH</th>
                                <th class="wrap_text">OP(OB)</th>
                                <th class="wrap_text">OP(OB)PH</th>
                                <th class="wrap_text">OP(SC)</th>
                                <th class="wrap_text">OP(SC)PH</th>
                                <th class="wrap_text">EWS</th>
                                <th class="wrap_text">EWS(PH)</th>
                                <th class="wrap_text">OB</th>
                                <th class="wrap_text">OB(PH)</th>
                                <th class="wrap_text">SC</th>
                                <th class="wrap_text">SC(PH)</th>
                                <th class="wrap_text">ST</th>
                                <th class="wrap_text">ST(PH)</th>
                                <th class="wrap_text">DASA</th>
                                <th class="wrap_text">SII</th>
                                <th class="wrap_text">ICCR</th>
                                <th class="wrap_text">MEA(WELFARE)</th>
                                <th class="wrap_text">SUPERNUMERARY</th>
                                <th class="wrap_text">TOTAL</th>
                                <th class="wrap_text">MALE</th>
                                <th class="wrap_text">FEMALE</th>
                                <th class="wrap_text">TOTAL</th>
                            </tr>    
                        </thead>
                        <tbody>
