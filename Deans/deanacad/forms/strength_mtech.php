            ...
            <div class="content_container">
                ...
                <div class="table_container">
                    <table border="1">
                        <thead>
                            <tr>
                                <th rowspan="2" class="wrap_text">Sl. No.</th>
                                <th rowspan="2" class="wrap_text">Branch</th>
                                <th colspan="2" class="wrap_text">OP</th>
                                <th colspan="2" class="wrap_text">OP-PH</th>
                                <th colspan="2" class="wrap_text">OBC</th>
                                <th colspan="2" class="wrap_text">OBC-PH</th>
                                <th colspan="2" class="wrap_text">SC</th>
                                <th colspan="2" class="wrap_text">SC-PH</th>
                                <th colspan="2" class="wrap_text">ST</th>
                                <th colspan="2" class="wrap_text">ST-PH</th>                          
                                <th colspan="2" class="wrap_text">EWS</th>
                                <th colspan="2" class="wrap_text">EWS-PH</th>
                                <th colspan="2" class="wrap_text">SP</th>
                                <th colspan="2" class="wrap_text">QIP</th>
                                <th colspan="2" class="wrap_text">QIP(POLY)</th>
                                <th colspan="2" class="wrap_text">DASA</th>
                                <th colspan="2" class="wrap_text">ICCR</th>
                                <th class="wrap_text">Total(M)</th>
                                <th class="wrap_text">Total(F)</th>
