...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query1 = "INSERT INTO nationalconference (author, title, conf_name, vol_pp, entity) VALUES (?, ?, ?,?, ?)";
...
<body>
    ...
    <?php
        ...
        <div class="subcontainer">
            <h2>National Conferences Publications for the year 2023-24</h2>
                ...
                <div class="left_container">
                    ...
                    <div class="form_container">
                        <form id="myForm" action="" method="post" onsubmit="return validateForm();" class="form_field">
                            ...
                            <input type="text" name="conf_name" placeholder="Name of National Conference" class="input-fields">
    ...
    if (id !== null && id !== undefined) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                window.location.href = 'editables/edit_national.php';
            }
        };
        xhr.send("id=" + id);
    } else {
