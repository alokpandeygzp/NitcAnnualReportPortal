...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_entry'])) {
    ...
    mysqli_stmt_bind_param($stmt, 'sssis', $staffName, $progTitle, $progDate, $id, $dep);
    ...
    <script>
        $(document).ready(function () {
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "edit_community_services.php?Id=<?php echo urlencode($id); ?>",
                    data: $(this).serialize() + "&update_entry=1",
                    dataType: 'json',
                    success: function (response) {
                        alert(response.message);
                        if (response.success) {
                            window.location.href = '../community_services.php';
                        }
                    },
                    error: function () {
...
<body>
    ...
    <div class="container">
        ...
        echo '<div class="user_strip">
                <div class="holder_1">
                    <a href="../../forms/community_services.php" class="user_to_dash">
        ...
        <div class="subcontainer">
            <div class="content_container">
                <p class="form_heading">Edit Community Services</p>

                <div class="form_container">

                    <form id="myForm" action="" method="post" class="form_field">
                        <input type="hidden" name="original_title" value="<?php echo $progTitle; ?>"
                            class="input-fields">

                        <table>

                            <tr>
                                <td class="label_field"><label for="faculty_name">Staff: </label>
                                </td>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="title" value="<?php echo $progTitle; ?>"
                                        class="input-fields" ></td>
                            </tr>

                            <tr>
                                <td class="label_field"> <label for="date" class="">Date: </label></td>
