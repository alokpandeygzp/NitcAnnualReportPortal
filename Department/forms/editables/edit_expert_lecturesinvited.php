...
$sql = "SELECT * FROM expert_lecturesinvited WHERE Id = '$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_entry'])) {
    ...
    mysqli_stmt_bind_param($stmt, 'ssssis', $staffName, $progTitle, $progStart, $progEnd, $id, $dep );
    ...
    <script>
        $(document).ready(function () {
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "edit_expert_lecturesinvited.php",
                    data: $(this).serialize() + "&update_entry=1",
                    dataType: 'json', 
                    success: function (response) {
                        alert(response.message);
                        if (response.success) {
                            window.location.href = '../expert_lecturesinvited.php';
                        }
                    },
                    error: function () {
...
<body>
    ...
    <div class="container">
        ...
        echo '<div class="user_strip">
                <div class="holder_1">
                    <a href="../../forms/expert_lecturesinvited.php" class="user_to_dash">
                    ...
                    <form id="myForm" action="" method="post" class="form_field">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="faculty_name" value="<?php echo $staff; ?>" class="input-fields">
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><input type="text" name="title" value="<?php echo $progTitle; ?>" class="input-fields"></td>
                            </tr>
