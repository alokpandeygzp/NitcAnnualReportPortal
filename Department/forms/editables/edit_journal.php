    ...
    <script>
        $(document).ready(function () {
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "edit_journal.php?Id=<?php echo urlencode($id); ?>",
            ...
            function validateForm() {
                var conNature = document.forms["myForm"]["author"].value;
                var conOrg = document.forms["myForm"]["title"].value;
                var conRevenue = document.forms["myForm"]["journal"].value;
                var conDate = document.forms["myForm"]["vol"].value;

                if (conNature.trim() == "" || conOrg.trim() == "" || conRevenue.trim() == "" ||  conDate.trim() == "") {
...
<body>
    ...
    <div class="container">        
        ...
        echo '<div class="user_strip">
                <div class="holder_1">
                    <a href="../../forms/journal.php" class="user_to_dash">
        ...
        <div class="subcontainer">
            <div class="content_container">
                <p class="form_heading">Edit Journal</p>
			    ...
			    <tr>
                                <td class="label_field"><label for="journal" class="label-fields">Name of Journal: </label></td>
                                <td><input type="text" name="journal" value="<?php echo $journal; ?>" class="input-fields"
                                        required></td>
                            </tr>
                            <tr>
