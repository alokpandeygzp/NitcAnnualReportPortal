...
$sql = "SELECT * FROM internationalconference WHERE id = '$id'";
...
<head>
    <title>Edit International Conference</title>
    ...
    <script>
        $(document).ready(function () {
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "edit_international.php?Id=<?php echo urlencode($id); ?>",
...
<body>
    ...
    <div class="container">        
        ...
        echo '<div class="user_strip">
                <div class="holder_1">
                    <a href="../../forms/international.php" class="user_to_dash">
        ...
        <div class="subcontainer">
            <div class="content_container">
                <p class="form_heading">Edit International Conference</p>
			    ...
			    <tr>
                                <td class="label_field"><label for="conf_name" class="label-fields">Name of International Conference: </label></td>
