...
<head>
    <title>Edit Other Services Entry</title>
            ...
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.success) {
                            window.location.href = '../other_services.php';
                        }
                    },
                    error: function () {
...
<body>
    ...
    <?php
        echo '<div class="user_strip">
                <div class="holder_1">
                    <a href="../../forms/other_services.php" class="user_to_dash">
        ...
        <div class="subcontainer">
            <div class="content_container">
                <p class="form_heading">Edit Other Services</p>
                    ...
                    <form id="myForm" action="" method="post" class="form_field">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><textarea name="title" class="input-fields textarea"
                                        ><?php echo $progTitle; ?></textarea></td>
                            </tr>
