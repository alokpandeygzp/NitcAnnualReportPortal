...
<body>
    ...
    <?php
        ...
        <div class="subcontainer">
            <h2>Faculty obtaining higher qualifications during year 2023-24</h2>
                ...
                <div class="left_container">
                    ...
                    <div class="form_container">
                        <form id="myForm" action="" method="post" onsubmit="return validateForm();" class="form_field">
                            ...
                            <input type="text" name="qualification" placeholder="Qualification" class="input-fields">
                            <input type="text" name="institute" placeholder="Institute" class="input-fields">
                            <div>
    ...
    if (id !== null && id !== undefined) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                window.location.href = 'editables/edit_faculty_qualification.php';
            }
        };
        xhr.send("id=" + id);
    } else {
