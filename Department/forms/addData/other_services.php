...
if ($_SERVER["REQUEST_METHOD"] == "POST"   && isset($_POST['form_type']) && $_POST['form_type'] == 'other_services') 
{
    ...
    if (isset ($id) && !empty ($id)) {
        ...
        $query = "INSERT INTO other_services (staff, title, date,  entity) VALUES (?, ?, ?, ?)";
    }
...
<head>
    ...
    $(document).ready(function() {
        $("#other_services1").submit(function(event) {
        ...
        function validateForm() {
            var staffName = document.forms["other_services1"]["staff"].value;
            var progTitle = document.forms["other_services1"]["title"].value;
            var date = document.forms["other_services1"]["date"].value;
...
<body>
    <div class="d-flex flex-column align-items-center w-100">
        <p class="form-name">Other Academic and Administrative Services rendered during year 2023-24</p>
        <div class="form-container">
            <form style="" id="other_services1" action="" method="post" onsubmit="return validateForm();">
                <input type="hidden" name="Id" value="<?php echo isset ($_GET['dataId']) ? $_GET['dataId'] : null; ?>">
                <input type="hidden" name="form_type" value="other_services">
