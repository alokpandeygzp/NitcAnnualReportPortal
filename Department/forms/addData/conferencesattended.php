...
if ($_SERVER["REQUEST_METHOD"] == "POST"   && isset($_POST['form_type']) && $_POST['form_type'] === 'conferenceattended') 
{
    ...
    if (isset ($id) && !empty ($id)) {
        ...
        $query = "INSERT INTO conferences_attened (title, name, start, end, entity) VALUES (?, ?, ?, ?, ?)";
    }
...
<head>
    ...
    $(document).ready(function() {
        $("#conferenceattended").submit(function(event) {
        ...
        function validateForm() {
            var staffName = document.forms["conferenceattended"]["name"].value;
            var progTitle = document.forms["conferenceattended"]["title"].value;
            var progStart = document.forms["conferenceattended"]["start"].value;
            var progEnd = document.forms["conferenceattended"]["end"].value;
...
<body>
    <div class="d-flex flex-column align-items-center w-100">
        <p class="form-name">Conferences/Summer/Winter School/Short term Courses/ Workshops Attended during year 2023-24</p>
        <div class="form-container">
            <form style="" id="conferenceattended" action="" method="post" onsubmit="return validateForm();">
                <input type="hidden" name="Id" value="<?php echo isset ($_GET['dataId']) ? $_GET['dataId'] : null; ?>">
                <input type="hidden" name="form_type" value="conferenceattended">
                <div class="row mb-3">
