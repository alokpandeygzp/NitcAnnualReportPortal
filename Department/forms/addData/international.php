...
if ($_SERVER["REQUEST_METHOD"] == "POST"   && isset($_POST['form_type']) && $_POST['form_type'] === 'international') 
{
    $author = $_POST["author"];
    ...
    if (isset ($id) && !empty ($id)) {
        ...
        $query = "INSERT INTO internationalconference (author, title, conf_name, vol_pp, entity) VALUES (?, ?, ?,?, ?)";
    }
...
<head>
    ...
    $(document).ready(function() {
        $("#international1").submit(function(event) {
        ...
        function validateForm() {
            var author = document.forms["international1"]["author"].value;
            var conf_name = document.forms["international1"]["conf_name"].value;
            var ic = document.forms["international1"]["title"].value;
            var nc = document.forms["international1"]["vol_pp"].value;
...
<body>
    <div class="d-flex flex-column align-items-center w-100">
        <p class="form-name">International Conferences Publications for the year 2023-24</p>
        <div class="form-container">
            <form style="" id="international1" action="" method="post" onsubmit="return validateForm();">
                ...
                <div class="row mb-3">
                    <label for="conf_name" class="col-sm-2 col-form-label label-class">Name of  International Conference: </label>
                    <div class="col-sm-10">
                           <input type="text" name="conf_name" placeholder="Name of  International Conference" class="form-control"></input>
                    </div>
                </div> 
