...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query1 = "INSERT INTO workshop (author, title, conf_name, vol_pp, entity) VALUES (?, ?, ?,?, ?)";
...
<head>
    <title>Workshops Publications</title>
    <meta charset="utf-8">
...
<body>
    ...
    <?php
        ...
        <div class="subcontainer">
            <h2>Workshops Publications for the year 2023-24</h2>
                ...
                <div class="left_container">
                    ...
                    <div class="form_container">
                        <form id="myForm" action="" method="post" onsubmit="return validateForm();" class="form_field">
                            ...
                            <input type="text" name="conf_name" placeholder="Name of Workshop" class="input-fields">
    ...
    if (id !== null && id !== undefined) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                window.location.href = 'editables/edit_workshop.php';
            }
        };
        xhr.send("id=" + id);
    } else {
