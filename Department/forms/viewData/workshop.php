...
<body>
    <div class="d-flex flex-column align-items-center gap-2 w-100 h-100">
        <div class="table-heading">Workshops Publications for the year 2023-24</div>
        <?php
        if ($userRole == 'admin')
            ...
            echo '
                ...
                <td class="box">' . $vol . '</td>
                    <td class="">
                            ...
                            <button class="edit_btn" data-id="workshop:form-12:' . $id . '"><i class="fas fa-edit"></i></button>
                            <button class="delete_btn" onclick="handleDeleteClick(' . $id . ', \'workshop\')"><i class="fas fa-trash-alt"></i></button>
