...
<body>
    ...
    <div class="container">
        ...
        <div class="subcontainer">
            <h2>Consultancy and Testing for year 2023-24</h2>
            <div class="content_container">
                <div class="left_container">

                    <div class="form_container">
                        <form id="myForm" action="" method="post" onsubmit="return validateForm();" class="form_field">
                            <input type="text" name="nature" placeholder="Nature of service" class="input-fields">
                            ...
                            <input type="text" type="number" onkeypress="return isNumberKey(event)" name="revenue"
                                placeholder="Revenue earned" class="input-fields">
                ...
                <div class="table_container">
                    ...
                    <?php
                    if ($userRole == 'admin')
                        $sql = "SELECT * FROM consultancy order by date";
                    else
                        $sql = "SELECT * FROM consultancy where entity='$userRole' order by date";
    ...
    if (id !== null && id !== undefined) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                window.location.href = 'editables/edit_consultancy.php';
            }
        };
        xhr.send("id=" + id);
    } else {
