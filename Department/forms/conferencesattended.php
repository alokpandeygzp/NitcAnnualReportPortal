...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query1 = "INSERT INTO conferences_attened(title, name, start, end, entity) VALUES (?, ?, ?, ?, ?)";
...
<body>
    ...
    <?php
        ...
        <div class="subcontainer">
            <h2>Conferences/Summer/Winter School/Short term Courses/ Workshops Attended during year 2023-24</h2>
    ...
    if (id !== null && id !== undefined) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                window.location.href = 'editables/edit_conferences_attened.php';
            }
        };
        xhr.send("id=" + id);
    } else {
