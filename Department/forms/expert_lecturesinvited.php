...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query1 = "INSERT INTO expert_lecturesinvited (staff, title, start, end, entity) VALUES (?, ?, ?, ?, ?)";
...
<head>
    <title>Expert Lectures Invited</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
        ...
        <div class="subcontainer">
            <h2>Expert lectures Invited in Conferences/Seminar/workshops during year 2023-24</h2>
            <div class="content_container">
                <div class="left_container">
                    ...
                    <div class="form_container">
                        <form id="myForm" action="" method="post" onsubmit="return validateForm();" class="form_field">
                            ...
                            <input type="text" name="faculty_name" placeholder="Name of Speaker" class="input-fields">
                ...
                <div class="table_container">
                    ...
                    <?php
                    if ($userRole == 'admin')
                        $sql = "SELECT * FROM expert_lecturesinvited order by start";
                    else
                        $sql = "SELECT * FROM expert_lecturesinvited where entity='$userRole' order by start";
    ...
    if (id !== null && id !== undefined) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                window.location.href = 'editables/edit_expert_lecturesinvited.php';
            }
        };
        xhr.send("id=" + id);
    } else {
