                ...
                <div class="left_container">
                    ...
                    <h2>Edit Conferences</h2><br>
                        <form id="myForm" action="" method="post" class="form_field">
                            ...
                            <label for="faculty_name">Name of Staff:</label>
                            ...
                            <input type="text" name="title" value="<?php echo $title; ?>" class="input-fields" readonly><br><br>

                            <label for="start">Start Date:</label>
                            <input type="date" name="start" value="<?php echo $start; ?>" class="input-fields" required><br><br>

                            <label for="end">End Date:</label>
                            <input type="date" name="end" value="<?php echo $end; ?>" class="input-fields" required><br><br>

                            <label for="entity">Entity:</label>
                            <input type="text" name="entity" value="<?php echo $dep; ?>" class="input-fields" readonly><br><br>
