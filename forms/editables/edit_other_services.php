            ...
            $("#myForm").submit(function (event) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.success) {
                            // Redirect to the other services page after a successful update
                            window.location.href = '../other_services.php?user=<?php echo urlencode($lname); ?>';
                        }
                    },
                    error: function () {
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><textarea name="title" class="input-fields textarea"
                                        readonly><?php echo $progTitle; ?></textarea></td>
                            </tr>
